...
public class Main{
    public static void main(String [] args){
        ...
        System.out.println("Testing Requirement 1:");
        System.out.println("Shield 1 is built from no-argument constructor, it is using default value");
        System.out.println(shield1.toString());
        System.out.println("Shield 2 is built from argument constructor, it is using 2.5, 7.0 and \"Fire\" parameters");
        ...
        System.out.println("Testing Requirement 2:");
        System.out.println("Setting Shield 1 radius to 5.0 and thickness to 3.0 (Valid)...");
        ...
        System.out.println("Setting Shield 1 radius to -5.0 and thickness to -3.0 (Invalid)...");
        try{
            shield1.setRadius(-5.0);
        ...
        System.out.println("Setting ElementType to empty (Should become Neutral)");
        ...
        System.out.println("Testing Requirement 3:");
        System.out.println("Check whether mana and defense calculation is correct!")
        System.out.println(shield2.toString()); //defense: 19.25    mana cost: 39.0
        System.out.println(shield3.toString()); //defense: 28.0     mana cost: 104.0

        //Requirement 4: Use static methods to calculate shield properties for arbitrary parameter combinations
        System.out.println("Testing Requirement 4 (Pass in radius=3.0, thickness = 4.0, elementType=Ice directly into static method):");
        System.out.printf("Static Defense: %.2f%n",MagicShield.calculateDefensePower(3.0, 4.0, "Ice")); // If works correctly: (3*4)*1.2 = 14.4
        System.out.printf("Static Mana Cost: %.1f%n",MagicShield.calculateManaCost(3.0, 4.0)+"\n"); // If works correctly: 3*10 + 4*2 = 38.0
        
        //Requiremet 5: Output the total number of shields created (verify the static counter) 
        System.out.println("Testing Requirement 5:");
